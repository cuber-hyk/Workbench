...
- 设置页更新面板：`src/components/AppUpdatePanel.tsx`
...
当检测到新版本时，左下角“本地模式”附近显示更新提示。该提示只是提醒和快捷入口，点击后进入设置页“软件更新”面板，不会直接下载、安装或重启。

设置页“软件更新”面板展示当前版本、最新版本、更新说明和状态。用户确认后才能下载并安装更新；安装完成后需要用户点击重启入口完成更新。
