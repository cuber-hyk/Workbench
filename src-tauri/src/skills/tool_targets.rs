...
pub(super) const TOOL_TARGET_DEFINITIONS: &[ToolTargetDefinition] = &[
    ...
    ToolTargetDefinition {
        ...
        project_path: Some(&[".deveco", "skills"]),
    },
    ToolTargetDefinition {
        key: "hermes",
        name: "Hermes",
        global_path: &[".hermes", "skills"],
        project_path: Some(&[".hermes", "skills"]),
    },
    ToolTargetDefinition {
        key: "kimi",
        name: "Kimi Code",
        global_path: &[".kimi-code", "skills"],
        project_path: Some(&[".kimi-code", "skills"]),
    },
    ToolTargetDefinition {
        key: "pi",
        name: "Pi Agent",
        global_path: &[".pi", "agent", "skills"],
        project_path: Some(&[".pi", "agent", "skills"]),
    },
    ToolTargetDefinition {
        key: "gemini",
        name: "Gemini CLI",
    ...
    ToolTargetDefinition {
        ...
        project_path: Some(&[".factory", "skills"]),
    },
    ToolTargetDefinition {
        key: "amp",
        name: "Amp",
        global_path: &[".config", "agents", "skills"],
        project_path: Some(&[".amp", "skills"]),
    },
    ToolTargetDefinition {
        key: "kiro",
        name: "Kiro CLI",
    ...
    ToolTargetDefinition {
        ...
        project_path: Some(&[".junie", "skills"]),
    },
];
