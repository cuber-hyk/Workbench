...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            diagnostics::get_local_workspace_system_status,
            ...
            projects::inspect_remote_project_import,
            projects::import_remote_project,
            ...
            skills::set_local_status_refresh_interval,
            skills::set_start_hidden_to_tray,
            skills::set_github_api_token,
            skills::clear_github_api_token,
            skills::test_github_api_token,
            ...
            skills::inspect_project_skills,
            skills::apply_project_skill_action,
            skills::batch_enable_project_skills,
